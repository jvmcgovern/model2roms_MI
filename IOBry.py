...
def createBryFile(confM2R):
    ...
    if confM2R.write_ice:
        ...
        tisrf_west = f1.createVariable('tisrf_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,
                                       fill_value=grdROMS.fillval)
        tisrf_west.long_name = "time-averaged temperature of ice surface western boundary conditions"
        ...
        sig11_south = f1.createVariable('sig11_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,
                                        fill_value=grdROMS.fillval)
        sig11_south.long_name = "time-averaged internal ice stress 11 component southern boundary conditions"
        ...
        sig12_south = f1.createVariable('sig12_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,
                                        fill_value=grdROMS.fillval)
        sig12_south.long_name = "time-averaged internal ice stress 12 component southern boundary conditions"
        ...
        sig22_south = f1.createVariable('sig22_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,
                                        fill_value=grdROMS.fillval)
        sig22_south.long_name = "time-averaged internal ice stress 22 component southern boundary conditions"
